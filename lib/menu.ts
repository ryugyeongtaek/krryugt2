...
export const menuItems: MenuItem[] = [
  ...
  { id: 'demand-profile', label: 'SKU 수요 프로파일', href: '/analysis/demand-profile', icon: BarChart3, roles: ['USER', 'ADMIN'], section: 'ANALYSIS' },
      ...
      { id: 'agent', label: 'SCM Agent', href: '/agent', icon: BarChart3, roles: ['USER', 'ADMIN'], section: 'ANALYSIS' },
  { id: 'purchase-recommendation', label: '발주 추천', href: '/analysis/purchase-recommendation', icon: BarChart3, roles: ['USER', 'ADMIN'], section: 'ANALYSIS' },
